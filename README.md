...
📍 **Ahmedabad, Gujarat, India** | 💻 **Full-Stack Software Engineer** | 🎓 **B.E. IT @ GTU (CGPA 8.0/10, May 2026)** | 🚀 **Open to SDE Roles**
...
> I turn complex engineering problems into fast, reliable, and scalable products — the kind
> that handles real load and real users. I've shipped a hospital-ops platform serving 3 hospitals,
> an IoT patient-vitals pipeline ingesting 500+ metrics/hour, and a real-time collaborative code
> editor scaling to 100+ concurrent users at sub-200ms latency — with 99.9% uptime, zero
> regression defects, and 40% bundle reduction to show for it.
...
| Award | Event | Year |
|---|---|---|
| 🥇 1st Place | HackOple Hackathon, Milople Technologies (AI Code Reviewer & Generator) | 2025 |
| 🏆 Winner | TechManjari TechFest, GyanManjari Innovative University | 2025 |
...
> *"Build for impact, ship with clarity"* — I build tools to solve real problems, always pushing for clean architecture and performance that actually matters.
